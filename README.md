...
* `12` Включить реле К1 в случае, если на IN1 низкий логический уровень
...
* `22` Включить реле К2 в случае, если на IN1 низкий логический уровень
...
* `36` Включить реле К3 в случае, если измеренное напряжение ниже порогового
* `37` Включить реле К3 в случае, если измеренное напряжение ниже порогового и на IN1 низкий логический уровень
...
* `50` Отключить реле К5 (внешнее) 
* `51` Включить реле К5 при любых условиях
* `52` Включить реле К5 в случае, если на IN1 низкий логический уровень
...
* Реле K1 - АСС (потребители, эммуляция нажатия педали СТОП)
* Реле К2 - Зажигание
* Реле К3 - Стартер
* Реле К4 - 
...
* `{"timer":600,"run":[22,7,36,6,4,30,5],"cmd":7,"det":30}` - запуск (только зажигание и стартер)
* `{"timer":600,"run":[52,5,22,7,36,6,4,30,7,50,5],"cmd":7,"det":30}` - запуск (обходчик иммо., зажигание, стартер)
* `{"timer":600,"run":[52,5,12,5,22,7,36,6,4,30,7,50,5],"cmd":7,"det":30}`- запуск (обходчик иммо., потребители, зажигание, стартер)
* `{"timer":600,"run":[52,5,12,5,22,7,36,6,4,30,7,10,2,50,5],"cmd":7,"det":30}`- запуск (обходчик иммо., потребители, зажигание, стартер, отключение потребителей)
* `{"timer":600,"run":[52,5,22,5,12,7,36,6,4,30,7,50,5,10,5],"cmd":7,"det":30}` - запуск (обходчик иммо., нажатие СТОП, зажигание, стартер, отпускание СТОП) для роботов
* `{"timer":1800,"run":[12,4],"cmd":7}` - вебасто на реле К1 
* `{"timer":1800,"run":[22,4],"cmd":7}` - вебасто на реле К2 
...
* `1*1234` - запустит сценарий `{"timer":600,"run":[52,5,12,5,22,7,36,6,4,30,7,50,5],"det":30}` - без отключения К1 (ACC)
* `2*1234` - запустит сценарий `{"timer":600,"run":[52,5,22,5,12,7,36,6,4,30,7,50,5,10,5],"det":30}`- с отключением К1
* `3*1234` - запустит сценарий `{"timer":1200,"run":[52,5,12,5,22,7,36,6,4,30,7,50,5],"sms":45,"det":30}` - c SMS
* `4*1234` - запустит сценарий `{"timer":1200,"run":[52,5,22,5,12,7,36,6,4,30,7,50,5,10,5],"sms":45,"det":30}`- с SMS
