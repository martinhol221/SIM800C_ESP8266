...
`{"timer":600,"run":[52,5,22,5,12,7,36,6,4,30,7,50,5,10,5],"cmd":7,"det":30}`
...
* `"det":30` установит время в 30 сек. через которое произойдет проверка запуска двигателя сравнением напряжений
