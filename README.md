...
* Запуск: `{"timer":600,"run":[22,7,36,6,4,30,5],"cmd":7,"det":30}` (K2-ON, 3 sec, K3-ON, 1.25 sec, K3-OFF)
* Запуск: `{"timer":600,"run":[52,5,22,7,36,6,4,30,7,50,5],"cmd":7,"det":30}` (K5-ON, 0.5 sec, K2-ON, 3 sec, K3-ON, 1.25 sec, K3-OFF, 3 sec, K5-OFF)
* Запуск: `{"timer":600,"run":[52,5,12,5,22,7,36,6,4,30,7,50,5],"cmd":7,"det":30}` (K5-ON, 0.5 sec, K1-ON, 0.5 sec, K2-ON, 3 sec, K3-ON, 1.25 sec, K3-OFF, 3 sec, K5-OFF)
* Запуск: `{"timer":600,"run":[52,5,12,5,22,7,36,6,4,30,7,50,5],"cmd":7,"det":30}` - без отключения потребителей после запуска
* Запуск: `{"timer":600,"run":[52,5,22,5,12,7,36,6,4,30,7,50,5,10,5],"cmd":7,"det":30}`- с отключением потребителей после запуска
* Стоп:   `{"timer":0,"run":[50,4,40,4,30,4,10,4],"cmd":7}`
