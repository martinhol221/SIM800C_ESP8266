...
* Запуск: `{"timer":600,"run":[22,7,36,6,4,30,5],"cmd":7,"det":30}` без иммобилайзера (зажигание и стартер)
* Запуск: `{"timer":600,"run":[52,5,22,7,36,6,4,30,7,50,5],"cmd":7,"det":30}` с иммобилайзером (зажигание и стартер)
* Запуск: `{"timer":600,"run":[52,5,12,5,22,7,36,6,4,30,7,50,5],"cmd":7,"det":30}` с иммобилайзером (потребители, зажигание и стартер)
