...
* `{"timer":600,"run":[22,7,36,6,4,30,5],"cmd":7,"det":30}` - запуск (только зажигание и стартер), время прогрева 600 секунд 
...
* `{"timer":600,"run":[52,5,12,5,22,7,36,6,4,30,7,10,2,50,5],"cmd":7,"det":30}`- (обходчик иммо., потребители, зажигание, стартер)
* `{"timer":600,"run":[52,5,22,5,12,7,36,6,4,30,7,50,5,10,5],"cmd":7,"det":30}`- (обходчик иммо., нажатие СТОП, зажигание, стартер)
