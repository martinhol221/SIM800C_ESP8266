...
Устройство генерирует точку доступа SSID `Webasto_123456` на 600 секунд с паролем `martinhol221` , к ктоторой можно подключиться с телефона для обновления прошивки или внесения изменений в настройки, страница настроек доступна по адресу `http://192.168.4.1`. Активация WIFI возможна несколькими способами
