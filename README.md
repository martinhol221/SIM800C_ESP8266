...
* Запуск, только зажигание и стартер: `{"timer":600,"run":[22,7,36,6,4,30,5],"cmd":7,"det":30}`
* Запуск, обходчик иммо., зажигание, стартер `{"timer":600,"run":[52,5,22,7,36,6,4,30,7,50,5],"cmd":7,"det":30}`
* Запуск,обходчик иммо., потребители, зажигание, стартер `{"timer":600,"run":[52,5,12,5,22,7,36,6,4,30,7,50,5],"cmd":7,"det":30}`
* Запуск: `{"timer":600,"run":[52,5,12,5,22,7,36,6,4,30,7,50,5],"cmd":7,"det":30}`
* Запуск: `{"timer":600,"run":[52,5,22,5,12,7,36,6,4,30,7,50,5,10,5],"cmd":7,"det":30}`
* Вебасто на реле К1 `{"timer":1800,"run":[12,4],"cmd":7}`
* Вебасто на реле К2 `{"timer":1800,"run":[22,4],"cmd":7}`
* Стоп на все        `{"timer":0,"run":[50,3,40,3,30,3,20,3,10,3],"cmd":7}`
