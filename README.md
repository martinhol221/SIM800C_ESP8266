...
* Запуск: `{"timer":600,"run":[52,5,12,5,22,7,36,6,4,30,7,50,5],"cmd":7,"det":30}` - без отключения К1 (ACC)
* Запуск: `{"timer":600,"run":[52,5,22,5,12,7,36,6,4,30,7,50,5,10,5],"cmd":7,"det":30}`- с отключением К1
* Стоп:   `{"timer":0,"run":[50,4,40,4,30,4,20,4,10,4],"cmd":7}` или `{"timer":1}`
...
* `#`      - удалит ошибочно введенные символы
* `0`      - отключит все реле  `{"timer":0,"run":[50,4,40,4,30,4,20,4,10,4],"cmd":7}`
